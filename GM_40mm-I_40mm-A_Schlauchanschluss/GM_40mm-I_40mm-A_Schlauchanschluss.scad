...
difference(){
    union(){
        translate([0,0,15]){
            difference(){
                union(){
                    rotate([0,90,0]) translate([-5,0,4.9]) cylinder(30,3.5,3.5);
                    cylinder(10,26.8,26.8);
                }    
                rotate([0,90,0]) translate([-5,0,5]) cylinder(30,2,2);
                translate([0,0,-0.1]){
                    cylinder(10.2,15,15);
                }    
            }    
	...
	difference()
	{
		cylinder(r = hex_nut_dia(dia)/2-5,h = hi);
    ...
    rotate([0,0,0]) translate([0,32,-0.1]) cylinder(30,6,10);
    rotate([0,0,45]) translate([0,32,-0.1]) cylinder(30,10,6);
    rotate([0,0,90]) translate([0,32,-0.1]) cylinder(30,6,10);
    rotate([0,0,135]) translate([0,32,-0.1]) cylinder(30,10,6);
    rotate([0,0,180]) translate([0,32,-0.1]) cylinder(30,6,10);
    rotate([0,0,-45]) translate([0,32,-0.1]) cylinder(30,10,6);
    rotate([0,0,-135]) translate([0,32,-0.1]) cylinder(30,10,6);
}    
...
module thread_out(dia,hi,thr=50)
{
...
module thread_in(dia,hi,thr=50)
{
	p = get_coarse_pitch(dia);
	h = (cos(30)*p)/8;
	Rmin = (dia/2) - (5*h);	// as wiki Dmin

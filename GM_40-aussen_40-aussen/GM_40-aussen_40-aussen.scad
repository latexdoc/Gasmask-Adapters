...
difference(){
 thread_out(39.5,40);
 translate([0,0,-0.1]) cylinder(50,11,11); 
//Konnektor oben
 for (z=[0:3]){
  rotate([0,0,0+z*90]) translate([11,0,25]) cylinder(15.1,1.5,1.5);    
  rotate([0,0,45+z*90]) translate([11,0,35]) sphere(1.5);    
 }
//Konnektor unten 
 for (z=[0:3]){
  rotate([0,0,0+z*90]) translate([11,0,-0.1]) cylinder(15.1,1.5,1.5);    
  rotate([0,0,45+z*90]) translate([11,0,5]) sphere(1.5);    
 } 
}    
